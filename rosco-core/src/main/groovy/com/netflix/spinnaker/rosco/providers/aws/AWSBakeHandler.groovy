...
public class AWSBakeHandler extends CloudProviderBakeHandler {
  ...
  private static final String UNECRYPTED_IMAGE_NAME_TOKEN = "amazon-(chroot|ebs): Creating unencrypted AMI"
  ...
  Bake scrapeCompletedBakeResults(String region, String bakeId, String logsContent) {
    ...
    logsContent.eachLine { String line ->
      ...
      } else if (line =~ UNECRYPTED_IMAGE_NAME_TOKEN) {
        line = line.replaceAll(UNECRYPTED_IMAGE_NAME_TOKEN, "").trim()
